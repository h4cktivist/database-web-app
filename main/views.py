...
from .models import Positions, SessionTypes, Staff, Sessions, Tickets, Sales, ExportedReports
from customers.models import Customers
from movies.models import Movies

from .forms import PositionsForm, SessionTypesForm, StaffForm, SessionsForm, \
