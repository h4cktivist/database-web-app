...
from .models import Halls, Positions, SessionTypes, Staff, Sessions, Tickets, Sales, ExportedReports
from customers.models import Customers
from movies.models import Movies

from .forms import HallsForm, PositionsForm, SessionTypesForm, StaffForm, SessionsForm, \
